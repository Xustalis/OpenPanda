...
const ja: Messages = {
  ...
  'policy.title': 'ポリシー',
  'policy.subtitle': 'このノードの判断: 承認・ルーティング・メモリ上限・モデル注入。',
  'policy.approval': '承認ゲート',
  'policy.approvalHelp': '実行前に同意を求めるタイミング。',
  'policy.approvalAlways': '毎回確認',
  'policy.approvalOnRequest': '不可逆な時だけ',
  'policy.approvalNever': '確認しない',
  'policy.tools': 'エージェントのツール',
  'policy.toolsMinimal': '最小（アダプタの許可リスト）',
  'policy.toolsExtended': '拡張（スキル・サブエージェント・MCP）',
  'policy.injection': 'モデル注入',
  'policy.injectionAuto': '自動',
  'policy.injectionAlways': '常に',
  'policy.injectionNever': 'しない',
  'policy.limits': 'メモリ上限（文字）',
  'policy.limitUser': 'USER.md',
  'policy.limitMemory': 'MEMORY.md',
  'policy.limitProject': 'プロジェクトごと',
  'policy.preferred': '優先エージェント',
  'policy.preferredHelp': 'カンマ区切り。ルーティングで加点されます。',
