...
const de: Messages = {
  ...
  'policy.subtitle': 'Wie dieser Knoten entscheidet: Freigabe, Routing, Speichergrenzen, Modell-Injektion.',
  'policy.approval': 'Freigabe',
  'policy.approvalHelp': 'Wann eine Aufgabe vor dem Start deine Zustimmung braucht.',
  'policy.approvalAlways': 'immer fragen',
  'policy.approvalOnRequest': 'bei Irreversiblem fragen',
  'policy.approvalNever': 'nie fragen',
  ...
  'policy.injection': 'Modell-Injektion',
  'policy.injectionAuto': 'auto',
  'policy.injectionAlways': 'immer',
  'policy.injectionNever': 'nie',
  'policy.limits': 'Speichergrenzen (Zeichen)',
  'policy.limitUser': 'USER.md',
  'policy.limitMemory': 'MEMORY.md',
  'policy.limitProject': 'pro Projekt',
  'policy.preferred': 'Bevorzugte Agents',
  'policy.preferredHelp': 'Kommagetrennt; erhalten einen Routing-Bonus.',
  'policy.saved': 'Richtlinien gespeichert',
