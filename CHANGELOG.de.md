...
Die v0.0.9-Linie läuft unter dem Codenamen **Periapsis** weiter: eine Datagramm-Ebene und NAT-Traversal für Peers, die kein WebSocket halten können, verschlüsselte DTN-Payloads, ein Lite-Build für beschränkte Geräte und ein Zuverlässigkeits-Pass der Task-Pipeline dafür, wie das Modell die Queue steuert.
